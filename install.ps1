...
if ($jabbaVersion -eq "latest")
{
    ...
    $jabbaVersion = (Invoke-RestMethod https://api.github.com/repos/Mythical-Forest-Collective/jabba/releases/latest).body
}
...
{
    Invoke-WebRequest https://github.com/Mythical-Forest-Collective/jabba/releases/download/$jabbaVersion/jabba-$jabbaVersion-windows-amd64.exe -UseBasicParsing -OutFile $jabbaHome/bin/jabba.exe
}
