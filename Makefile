...
publish: clean build-release
	...
	github-release release --user Mythical-Forest-Collective --repo jabba --tag ${VERSION} \
	--name "${VERSION}" --description "${VERSION}" && \
	github-release upload --user Mythical-Forest-Collective --repo jabba --tag ${VERSION} \
