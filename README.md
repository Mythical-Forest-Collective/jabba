# jabba ![Latest Version](https://img.shields.io/badge/latest-0.11.2-blue.svg) [![Build Status](https://travis-ci.org/Mythical-Forest-Collective/jabba.svg?branch=master)](https://travis-ci.org/Mythical-Forest-Collective/jabba)
...
curl -sL https://github.com/Mythical-Forest-Collective/jabba/raw/master/install.sh | bash && . ~/.jabba/jabba.sh
```
...
```sh
export JABBA_VERSION=...
curl -sL https://github.com/Mythical-Forest-Collective/jabba/raw/master/install.sh | bash -s -- --skip-rc && . ~/.jabba/jabba.sh
```
...
> export JABBA_VERSION=...
`curl -sL https://github.com/Mythical-Forest-Collective/jabba/raw/master/install.sh | bash; and . ~/.jabba/jabba.fish` 
...
RUN curl -sL https://github.com/Mythical-Forest-Collective/jabba/raw/master/install.sh | \
...
Invoke-Expression (
  Invoke-WebRequest https://github.com/Mythical-Forest-Collective/jabba/raw/master/install.ps1 -UseBasicParsing
).Content
```
...
```sh
git clone https://github.com/Mythical-Forest-Collective/jabba $GOPATH/src/github.com/Mythical-Forest-Collective/jabba 
cd $GOPATH/src/github.com/Mythical-Forest-Collective/jabba 
make fetch
